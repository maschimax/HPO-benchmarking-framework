...
space_keras = [
    ...
    skopt.space.Categorical([0, 16, 32, 64, 128, 512], name='hidden_layer1_size'),
    skopt.space.Categorical([0, 16, 32, 64, 128, 512], name='hidden_layer2_size'),
    skopt.space.Categorical([0, 16, 32, 64, 128, 512], name='hidden_layer3_size'),
    skopt.space.Categorical([0, 16, 32, 64, 128, 512], name='hidden_layer4_size'),
